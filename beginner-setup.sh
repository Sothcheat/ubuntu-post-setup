...
# Logging setup, colors, functions here as you wrote...
...
# Flathub repo, Flatpak install
step_start "📦 Enabling Flathub Flatpak repository"
sudo apt install -y flatpak unzip
...
# IDEs
if confirm "🖥️ Install developer IDEs (Visual Studio Code)?"; then
